CREATE TABLE [dbo].[WarehouseIncidents](
    ...
    CONSTRAINT [PK_WarehouseIncidents] PRIMARY KEY ([IncidentId])
) 
GO

CREATE INDEX [IX_WarehouseIncidents_CreateDate] ON [dbo].[WarehouseIncidents] ([CreateDate])
GO

CREATE INDEX [IX_WarehouseIncidents_ResolveDate] ON [dbo].[WarehouseIncidents] ([ResolveDate])

GO

CREATE INDEX [IX_WarehouseIncidents_SupportTicketId] ON [dbo].[WarehouseIncidents] ([SupportTicketId])

GO

CREATE INDEX [IX_WarehouseIncidents_SubscriptionId] ON [dbo].[WarehouseIncidents] ([SubscriptionId])
