CREATE VIEW [dbo].[vw_Customer]
	AS 
	SELECT    1    as test
--	hmc.HMC AS isHMC, CASE WHEN a.DimAccountKey IS NULL THEN 0 ELSE 1 END AS isActive, CASE WHEN t .DimAccountKey IS NULL THEN 0 ELSE t .BurndownConsumption END AS isTop20, c.CustomerId, 
