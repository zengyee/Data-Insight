CREATE TABLE [dbo].[FactMeteredUsageDaily](
    ...
    --CONSTRAINT [PK_FactMeteredUsageDaily] PRIMARY KEY ([DimDateKey], [DimSubscriptionKey], [DimTenantKey], [DimAccountKey], [DimOfferKey], [BillingDimGeographyKey], [ServiceUseDimGeographyKey], [TenantDimGeographyKey], [AccountDimGeographyKey], [DimServiceKey], [DimBillingSystemKey], [DimLocationKey], [DimMeteredServiceKey], [DimProjectKey])
) ON [PRIMARY]
